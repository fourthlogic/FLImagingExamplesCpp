...
int main()
{
	...
	do
	{
		...
		if((eResult = floSourceObject.Load(L"../../ExampleImages/PlaneEstimatorFromFeaturePoints3D/box.fl3do")).IsFail())
		{
		...
		CPlaneEstimatorFromFeaturePoints3D planeEstimatorFromFeaturePoints3D;
