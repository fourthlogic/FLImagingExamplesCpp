...
int main()
{
	...
	do
	{
		...
		sumModifiedLaplacian.SetSourceImage(arrFliImage[EImageType_Source1]);
		...
		sumModifiedLaplacian.SetSourceImage(arrFliImage[EImageType_Source2]);
		...
		sumModifiedLaplacian.SetSourceImage(arrFliImage[EImageType_Source3]);
