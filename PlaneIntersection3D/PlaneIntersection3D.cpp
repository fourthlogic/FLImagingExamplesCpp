...
int main()
{
	...
	do
	{
		...
		{
			ErrorPrint(eResult, L"Failed to execute Plane Intersection 3D.");
			break;
		}
		...
		if((eResult = layer3DReference.DrawTextCanvas(flpLeftTop, L"Reference Plane", YELLOW, BLACK, 20)).IsFail())
		{
			ErrorPrint(eResult, "Failed to draw text.\n");
			break;
		}

		if((eResult = layer3DMeasurement.DrawTextCanvas(flpLeftTop, L"Measurement Plane", YELLOW, BLACK, 20)).IsFail())
		{
			ErrorPrint(eResult, "Failed to draw text.\n");
			break;
		}
