...
int main()
{
	...
	do
	{
		...
		layerDst1.DrawTextCanvas(TPoint<double>(0, 20), L"Maximum Distance", CYAN, BLACK);
		layerDst2.DrawTextCanvas(TPoint<double>(0, 20), L"Maximum Distance", CYAN, BLACK);
		...
		layerDst1.DrawFigureImage(fllMax1, CYAN);
		layerDst1.DrawTextImage(fllMax1.GetCenter(), CFLString<wchar_t>().Format(L"%.3lf", f64MaximumDistance1), CYAN, BLACK, 12, false, 0, EGUIViewImageTextAlignment_LEFT_BOTTOM);
		...
		layerDst2.DrawFigureImage(fllMax2, CYAN);
		layerDst2.DrawTextImage(fllMax2.GetCenter(), CFLString<wchar_t>().Format(L"%.3lf", f64MaximumDistance2), CYAN, BLACK, 12, false, 0, EGUIViewImageTextAlignment_RIGHT_TOP);
