...
int main()
{
	...
	do
	{
		...
		CGeometricMatch geometricMatch;
		...
		geometricMatch.SetFeatureCount();
		...
		if(IsFail(res = geometricMatch.GetLearnedFeature(flfaFeaturePoints)))
		{
		...
		geometricMatch.SetAngleTolerance(180.);
		...
		int64_t i64ResultCount = geometricMatch.GetResultCount();
