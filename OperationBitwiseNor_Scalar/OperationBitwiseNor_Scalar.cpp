...
int main()
{
	...
	do
	{
		...
		operationBitwiseNor.SetSourceImage(fliSourceDestinationImage);
		...
		operationBitwiseNor.SetOperationSource(EOperationSource_Scalar);

		// 스칼라 값 지정 // Set the Scalar value
		operationBitwiseNor.SetScalarValue(CMultiVar<double>(111));
