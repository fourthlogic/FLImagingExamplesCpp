...
int main()
{
	...
	do
	{
		...
		if(IsFail(res = arrFliImage[EType_Operand].Load(L"../../ExampleImages/ConvolutionFD/Operand.flif")))
		{
			ErrorPrint(res, "Failed to load the image file.\n");
			break;
		}
		...
		convolutionFD.SetOperandImage(arrFliImage[EType_Operand]);
		// Destination 이미지 설정 // Set destination image 
		convolutionFD.SetDestinationImage(arrFliImage[EType_Destination]);
