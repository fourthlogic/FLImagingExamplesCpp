...
int main()
{
	...
	do
	{
		...
		// 이미지 로드 // Loads image
		if(IsFail(res = arrFliImage[EType_Src].Load(L"../../ExampleImages/ImageConcatenatorGrid/mnist0.flif")))
		{
		...
		CImageConcatenatorGrid imageConcatenatorGrid;

		// Source 이미지 설정 // Set source image 
		imageConcatenatorGrid.SetSourceImage(arrFliImage[EType_Src]);

		// Destination 이미지 설정 // Set destination image 
		imageConcatenatorGrid.SetDestinationImage(arrFliImage[EType_Dst]);

		// Page scope 설정 // Set page scope
		imageConcatenatorGrid.SetPageScope(CImageConcatenatorGrid::EPageScope_Source_AllPage_Operand_None);
