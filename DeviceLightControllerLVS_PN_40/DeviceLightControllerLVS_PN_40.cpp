...
int main()
{
	...
	CDeviceLightControllerLVS_PN_40 lightControllerLVS_PN_40;
	...
	do
	{
...

		{
			...
			lightControllerLVS_PN_40.SetComPortNumber(i32ComPortNumber);
			...
			system("cls");
			// 컴포트 번호 설정 // Set the COM port number.
			lightControllerLVS_PN_40.SetBaudRate(i32BaudRate);
		}

		if(IsFail(res = lightControllerLVS_PN_40.Initialize()))
		{
		...
		while(true)
		{
			...
			if(i32SelectMode == 1)
			{
				...
				if(i32OnOff == 0)
					lightControllerLVS_PN_40.SetChannelState(i32Channel, true);
				else if(i32OnOff == 1)
					lightControllerLVS_PN_40.SetChannelState(i32Channel, false);
			}
			else if(i32SelectMode == 2)
			{
				...
				lightControllerLVS_PN_40.SetLightValue(i32Channel, u8Value);
			}
	...
	if(IsFail(res = lightControllerLVS_PN_40.Terminate()))
	{
