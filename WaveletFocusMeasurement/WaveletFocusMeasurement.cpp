...
int main()
{
	...
	do
	{
		...
		waveletFocusMeasurement.SetSourceImage(fliSrcImage1);
		...
		waveletFocusMeasurement.SetSourceImage(fliSrcImage2);
		...
		waveletFocusMeasurement.SetSourceImage(fliSrcImage3);
