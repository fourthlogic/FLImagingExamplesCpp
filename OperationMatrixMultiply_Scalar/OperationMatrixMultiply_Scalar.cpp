...
int main()
{
	...
	do
	{
		...
		operationMatrixMultiply.SetDestinationImage(arrFliImage[EType_Destination1]);
		// 연산 방식 설정 // Set operation source
		operationMatrixMultiply.SetOperationSource(EOperationSource_Scalar);
		// Multiply 값 설정 // Set Multiply value
		operationMatrixMultiply.SetScalarValue(CMultiVar<double>(1.5));
		...
		// Destination 이미지 설정 // Set the destination image
		operationMatrixMultiply.SetDestinationImage(arrFliImage[EType_Destination2]);
		// 연산 방식 설정 // Set operation source
		operationMatrixMultiply.SetOperationSource(EOperationSource_Scalar);
		// Multiply 값 설정 // Set Multiply value
		operationMatrixMultiply.SetScalarValue(CMultiVar<double>(2));
