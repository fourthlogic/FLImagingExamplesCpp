...
int main()
{
	...
	CDeviceLightControllerNARATECH_NRT_PH lightControllerNARATECH_NRT_PH;
	...
	do
	{
...

		{
			...
			lightControllerNARATECH_NRT_PH.SetComPortNumber(i32ComPortNumber);
			...
			system("cls");
			// 컴포트 번호 설정 // Set the COM port number.
			lightControllerNARATECH_NRT_PH.SetBaudRate(i32BaudRate);
		}

		if(IsFail(res = lightControllerNARATECH_NRT_PH.Initialize()))
		{
		...
		while(true)
		{
			...
			if(i32SelectMode == 1)
			{
				...
				if(i32OnOff == 0)
					lightControllerNARATECH_NRT_PH.SetChannelState(i32Channel, true);
				else if(i32OnOff == 1)
					lightControllerNARATECH_NRT_PH.SetChannelState(i32Channel, false);
			}
			else if(i32SelectMode == 2)
			{
				...
				lightControllerNARATECH_NRT_PH.SetLightValue(i32Channel, u8Value);
			}
	...
	if(IsFail(res = lightControllerNARATECH_NRT_PH.Terminate()))
	{
