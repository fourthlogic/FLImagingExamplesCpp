...
int main()
{
	...
	do
	{
		...
		// 이미지 로드 // Loads image
		if(IsFail(res = arrFliImage[EType_Source].Load(L"../../ExampleImages/FLLowLuminanceCorrectionType2/FLLowLuminanceCorrectionType2.flif")))
		{
		...
		CFLLowLuminanceCorrectionType2 flLowLuminanceCorrectionType2;
		// Source 이미지 설정 // Set source image
		flLowLuminanceCorrectionType2.SetSourceImage(arrFliImage[EType_Source]);
		// Destination 이미지 설정 // Set destination image 
		flLowLuminanceCorrectionType2.SetDestinationImage(arrFliImage[EType_Destination]);
