...
int main()
{
	...
	CDeviceCameraFrameGrabberHIK camHIK;
	...
	do
	{
		...
		flsInput = arrInput;
		i32InterfaceIndex = flsInput.ToInt32();
		...
		if(IsFail(res = camHIK.Initialize()))
		{
