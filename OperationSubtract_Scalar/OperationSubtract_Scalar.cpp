...
int main()
{
	...
	do
	{
		...
		operationSubtract.SetDestinationImage(arrFliImage[EType_Destination1]);
		// 연산 방식 설정 // Set operation source
		operationSubtract.SetOperationSource(EOperationSource_Scalar);
		// Scalar 값 설정 // Set Scalar value
		operationSubtract.SetScalarValue(CMultiVar<double>(30, 0, 0));
		...
		// Destination 이미지 설정 // Set destination image 
		operationSubtract.SetDestinationImage(arrFliImage[EType_Destination2]);
		// 연산 방식 설정 // Set operation source
		operationSubtract.SetOperationSource(EOperationSource_Scalar);
		// Scalar 값 설정 // Set Scalar value
		operationSubtract.SetScalarValue(CMultiVar<double>(0, 0, 30));
