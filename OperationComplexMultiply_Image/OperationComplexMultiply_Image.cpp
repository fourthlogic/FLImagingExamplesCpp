...
int main()
{
	...
	do
	{
		...
		if((res = operationComplexMultiply.SetOperandImage(fliOperandImage)).IsFail())
		{
		...
		if((res = operationComplexMultiply.SetOperationSource(EOperationSource_Image)).IsFail())
		{
