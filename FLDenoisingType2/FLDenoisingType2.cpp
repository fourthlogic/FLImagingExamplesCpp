...
int main()
{
	...
	do
	{
		...
		CFLDenoisingType2 flDenoisingType2;

		// Source 이미지 설정 // Set source image 
		if(IsFail(res = flDenoisingType2.SetSourceImage(fliSourceImage)))
		{
		...
		if(IsFail(res = flDenoisingType2.SetDestinationImage(fliConvertedImage)))
		{
		...
		if(IsFail(res = flDenoisingType2.SetKernel(3)))
		{
		...
		if(IsFail(res = flDenoisingType2.SetAmplitude(0.2)))
		{
		...
		if(IsFail(res = flDenoisingType2.SetOperationMode(CFLDenoisingType2::EOperationMode_Fast)))
		{
