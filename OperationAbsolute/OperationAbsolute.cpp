...
int main()
{
	...
	do
	{
		...
		// 이미지 로드 // Loads image
		if(IsFail(res = arrFliImage[EImageType_Source].Load(L"../../ExampleImages/OperationAbsolute/Flower.flif")))
		{
		...
		operationAbsolute.SetSourceImage(arrFliImage[EImageType_Source]);
		// Destination 이미지 설정 // Set destination image 
		operationAbsolute.SetDestinationImage(arrFliImage[EImageType_Destination]);
