...
int main()
{
	...
	do
	{
		...
		// 이미지 로드 // Loads image
		if(IsFail(res = arrFliImage[EType_Source].Load(L"../../ExampleImages/Retinex/wall.flif")))
		{
		...
		retinex.SetSourceImage(arrFliImage[EType_Source]);
		// Destination 이미지 설정 // Set destination image 
		retinex.SetDestinationImage(arrFliImage[EType_Destination]);
