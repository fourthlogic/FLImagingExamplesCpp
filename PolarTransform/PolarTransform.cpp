...
int main()
{
	...
	do
	{
		...
		// 이미지 로드 // Loads image
		if(IsFail(res = arrFliImage[EType_Source].Load(L"../../ExampleImages/PolarTransform/PolarTransformSrc.flif")))
		{
		...
		polarTransform.SetSourceImage(arrFliImage[EType_Source]);
		// Destination 이미지 설정 // Set destination image 
		polarTransform.SetDestinationImage(arrFliImage[EType_Destination]);
