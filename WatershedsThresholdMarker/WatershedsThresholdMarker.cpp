...
int main()
{
	...
	do
	{
		...
		if(IsFail(res = layer.DrawTextCanvas(CFLPoint<double>(0, 0), L"Threshold = 10", YELLOW, BLACK, 30, false, 0, EGUIViewImageTextAlignment_LEFT_TOP, L"", 1.f, 1.f, EGUIViewImageFontWeight_BOLD, false)))
		{
