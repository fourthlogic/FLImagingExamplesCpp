...
int main()
{
	...
	do
	{
		...
		if((result = arrFliImage[EImageType_Source].Load(L"../../ExampleImages/OperationCubeRoot/Sea3ChF32.flif")).IsFail())
		{
		...
		operationCubeRoot.SetSourceImage(arrFliImage[EImageType_Source]);
		// Destination 이미지 설정 // Set the destination image
		operationCubeRoot.SetDestinationImage(arrFliImage[EImageType_Destination]);
